...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oguser/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oguser/main/install/ins-xray2.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray2.sh
