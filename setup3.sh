...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oguser/main/install/ssh-vpn2.sh && chmod +x ssh-vpn2.sh && screen -S ssh-vpn ./ssh-vpn2.sh
...
sleep 1
wget https://raw.githubusercontent.com/${GitUser}/oguser/main/install/ins-xray.sh && chmod +x ins-xray.sh && screen -S ins-xray ./ins-xray.sh
