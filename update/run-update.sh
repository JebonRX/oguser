...
echo "|                Script By Nevermore              |" | lolcat
echo "'----------------------------------------------'" | lolcat
...
sleep 2
clear
echo -e "\e[0;32mGetting New Version Script By Nevermore...\e[0m"
sleep 1
echo ""
# UPDATE RUN-UPDATE
cd /usr/bin
...
wget -O bannermenu "https://raw.githubusercontent.com/${GitUser}/oguser/main/update/bannermenu.sh"
wget -O change-port "https://raw.githubusercontent.com/${GitUser}/oguser/main/change.sh"
wget -O add-ws "https://raw.githubusercontent.com/${GitUser}/oguser/main/add-user/add-ws.sh"
chmod +x update
chmod +x bannermenu
chmod +x change-port
chmod +x add-ws
